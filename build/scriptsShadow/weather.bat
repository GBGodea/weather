...
set CLASSPATH=%APP_HOME%\lib\weather-1.0.0-all.jar

@rem Execute weather
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %WEATHER_OPTS%  -jar "%CLASSPATH%" %CMD_LINE_ARGS%
...
if  not "" == "%WEATHER_EXIT_CONSOLE%" exit 1
exit /b 1
